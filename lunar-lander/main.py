...
while 0 <= choose <= 5:
    ...
    if choose == 5:
        ...
        env3.seed(3)
        simulate_env(env1, agent1, model_path='results/checkpoint_global_1_agents_iteration_6.pth',
                     n_simulation=n_simulation)
        simulate_env(env2, agent2, model_path='results/checkpoint_global_2_agents_iteration_8.pth',
                     n_simulation=n_simulation)
        simulate_env(env3, agent3, model_path='results/checkpoint_global_3_agents_iteration_8.pth',
                     n_simulation=n_simulation)
